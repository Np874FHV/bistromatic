...
I implemented a function that tests if `b * n ^ (-i) > a`. If it is true, then substract `b * n ^ (-i)` to the result, without creating a temporal number. The brute-force solution was, in the previous example, to do 
